...
import { supabase } from "./authHelpers.tsx";
import * as authHelpers from "./authHelpers.tsx";
import { adminHelpers } from "./adminHelpers.tsx";
import { migrationService } from "./migrationService.tsx";
...
systemRoutes.post("/migrate/schema-v2", async (c) => {
  try {
    ...
    const { isSuperAdminUser } = await import("./authHelpers.tsx");
